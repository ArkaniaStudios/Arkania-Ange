...
final class KnownTranslationsFactory{
	public static function command_argument_invalid(Translatable|string $param0) : Translatable{
		return new Translatable(KnownTranslationsKeys::COMMAND_ARGUMENT_INVALID, [
			0 => $param0,
		]);
	}
